...
public class SavingAccount extends Account {
    ...
    public SavingAccount(int initialBalance, int minBalance, int maxBalance, int rate) {
        ...
        if (minBalance >= maxBalance || minBalance < 0 ) {
            throw new IllegalArgumentException(
                    "Минимальный баланс не может быть больше максимального баланса или отрицательным, а у вас: " + minBalance
            );
        }
        if (initialBalance > maxBalance || initialBalance < minBalance || initialBalance < 0  ) {
            throw new IllegalArgumentException(
                    "Начальный баланс не может быть больше максимального баланса, меньше минимального или отрицательным, а у вас: " + initialBalance
            );
        }
